...
//CHANGE_SUGGESTIONS action actually effects two reducers.
const action = {
...
//check both the values for suggestions and fetching to make sure that they represent our expected state.
