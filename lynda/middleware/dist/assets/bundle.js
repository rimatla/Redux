...
/***/ function(module, exports, __webpack_require__) {
	...
	var unsubscribeGoalLogger = store.subscribe(function () {
	    return console.log('   Goal: ' + store.getState().goal);
	});
	 ...
	 * After 3 seconds and kill it, return the unsubscribeGoalLogger, to turn off the subscription when we're ready.*/
